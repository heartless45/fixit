...
class email extends StatefulWidget {
  ...
  email({required this.phoneno,required this.name});
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(bottom: 27, left: 33, right: 33),
                          width: double.infinity,
                          child: Text(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => address(name: widget.name, phoneno: widget.phoneno,email: email.text,)),
                              );
                            },
